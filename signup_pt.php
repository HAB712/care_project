   ...
   $password = $_POST['password'];
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        $HashedPass = password_hash($password, PASSWORD_BCRYPT);
         $Insquery = "INSERT INTO signup (name, phone,  email,  password, role) VALUES ('$name', '$phone', '$email', '$HashedPass', 'patient')";
  ...
  <div class="signup-wrapper">
    <div class="signup-card">
      ...
      <div class="signup-form">
        ...
        <form action="signup_pt.php" method="POST" id="signupForm">
          ...
          <button type="submit" name ="submit" class="btn btn-primary w-100 py-2" id="btn">Sign Up</button>
        </form>
      </div>
    </div>
  </div>
